...
@section('title', 'Edit Webhook - Hostiqo')
    ...
    <div class="row">
        <div class="col-lg-8">
            <form action="{{ route('webhooks.update', $webhook) }}" method="POST">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-bell me-2"></i> Deploy Notifications (Optional)
                    </div>
                    <div class="card-body">
                        <div class="mb-0">
                            <label for="slack_webhook_url" class="form-label">
                                <i class="bi bi-slack me-1"></i> Slack Webhook URL
                            </label>
                            <input type="url" class="form-control @error('slack_webhook_url') is-invalid @enderror" id="slack_webhook_url" name="slack_webhook_url" value="{{ old('slack_webhook_url', $webhook->slack_webhook_url) }}" placeholder="https://hooks.slack.com/services/YOUR/WEBHOOK/URL">
