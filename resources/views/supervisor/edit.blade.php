...
<div class="row">
    <div class="col-lg-8">
        <form action="{{ route('supervisor.update', $supervisorProgram) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="name" 
                               name="name" 
                               value="{{ old('name', $supervisorProgram->name) }}" 
                               required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="description" 
                               name="description" 
                               value="{{ old('description', $supervisorProgram->description) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="command" 
                               name="command" 
                               value="{{ old('command', $supervisorProgram->command) }}" 
                               required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="directory" 
                               name="directory" 
                               value="{{ old('directory', $supervisorProgram->directory) }}" 
                               required
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="numprocs" 
                                   name="numprocs" 
                                   value="{{ old('numprocs', $supervisorProgram->numprocs) }}" 
                                   min="1" 
                                   max="20" 
                                   required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="user" 
                                   name="user" 
                                   value="{{ old('user', $supervisorProgram->user) }}" 
                                   required>
                            @error('user')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="startsecs" 
                                   name="startsecs" 
                                   value="{{ old('startsecs', $supervisorProgram->startsecs) }}" 
                                   min="0" 
                                   required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="stopwaitsecs" 
                                   name="stopwaitsecs" 
                                   value="{{ old('stopwaitsecs', $supervisorProgram->stopwaitsecs) }}" 
                                   min="1" 
                                   required>
                    ...
                    <div class="form-check form-switch mb-3">
                        ...
                        <input class="form-check-input" 
                               ...
                               name="autostart" 
                               value="1" 
                               {{ old('autostart', $supervisorProgram->autostart) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-switch mb-3">
                        ...
                        <input class="form-check-input" 
                               ...
                               name="autorestart" 
                               value="1" 
                               {{ old('autorestart', $supervisorProgram->autorestart) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-switch">
                        ...
                        <input class="form-check-input" 
                               ...
                               name="is_active" 
                               value="1" 
                               {{ old('is_active', $supervisorProgram->is_active) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="stdout_logfile" 
                               name="stdout_logfile" 
                               value="{{ old('stdout_logfile', $supervisorProgram->stdout_logfile) }}"
